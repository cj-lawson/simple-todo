  ...
  return (
    <div className="min-h-screen w-screen bg-[#1c1c1c]">
      <div className="flex h-screen w-screen justify-center pt-10 text-primary-white">
        <div className="container flex w-5/6 max-w-[400px] flex-col space-y-12 md:w-3/5">
          ...
          <div className="mb-20 mt-20 space-y-8 text-primary-white">
            <div className="border-b border-[#282828] pb-2">
              <h3 className="mb-2 text-lg">Register</h3>
            ...
            <div className="mt-4 space-x-6">
              <form className="space-y-4" action="#">
                <div>
                  <label
                    htmlFor="email"
                    className="block text-sm font-medium leading-6 text-[#a0a0a0]"
                  >
                    Email address
                  </label>
                  <div className="mt-2">
                ...
                <div>
                  <button
                    type="submit"
                    className="flex w-full justify-center rounded-md  border border-[#3e3e3e] bg-[#2e2e2e] px-3 py-1.5 text-sm font-semibold leading-6 text-primary-white shadow-sm hover:brightness-125"
                  >
                    Register
                  </button>
                </div>
